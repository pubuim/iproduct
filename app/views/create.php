<article class="content content-new">
    <div class="wrapper">
        <div class="row">
            <div class="col-lg-12">
                <form action="?" method="POST">
                    <div class="form-group">
                        ...
                        <input class="form-control" id="site-url" name="url" type="text" value="<?php echo query("url", "http://") ?>" data-component="UrlCheck" data-title-container="#site-title" data-content-container="#site-content"  />
                    </div>
                    <div class="form-group">
